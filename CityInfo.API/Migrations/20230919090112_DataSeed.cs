        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, "The one with the catedral.", "Antwerp" },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "The most visited urban park in USA.", "Central Park" },
                    { 2, 1, "Big.", "Empire State Building" },
                    { 3, 2, "Gothic style", "Catedral Of Our Lady" },
                    { 4, 2, "Railway in Belguin", "Antwerp Central Station" },
